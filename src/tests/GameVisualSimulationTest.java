...
//    	game.addAgent(new GeneralAI(GeneralAI.LESION_NONE));
    	//game.addAgent(new RandomAI());
    	game.addAgent(new MyAI());

    	
    //	game.playVisual(900, false, true, Game.FOLLOW_ALL_TEAMS);
    	game.playVisual(400, false, true, Game.FOLLOW_ALL_TEAMS);
    }    
}
